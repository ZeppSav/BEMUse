...
class Grid_Options : public QWidget
{
    ...
    // Generate geometries
    std::vector<BEMUse::Parameter> Parameters;
    void Generate_Ellipsoid();
    void Generate_SemiEllipsoid();
    void Generate_Cylinder();
    void Generate_Barge();
    void Generate_SparBuoy();
    void Generate_TripleSpar();
    void Generate_OC3SparBuoy();
    void Generate_OC4TripleSpar();
    void Generate_WigleyHull();
