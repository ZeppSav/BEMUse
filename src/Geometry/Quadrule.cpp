...
//    There are NO other Chebyshev rules with double abscissas.
//
...
//
//    ORDER = 1 is the midpoint rule (and is not doublely an NCC rule//)
...
//  Purpose:
//
//    R8_GAMMA evaluates Gamma(X) for a double argument.
//
//  Discussion:
//
...
//    value XINF, the largest representable doubleing point number.
//
//  Local Parameters:
//
//  BETA   - radix for the doubleing-point representation.
//
...
//************************SYMMETRICAL TRIANGULAR QUADRATURE***************************
...
//************************SYMMETRICAL TRIANGULAR QUADRATURE END*******************************
